  ...
  <div class="container">
    {!! Form::open(['route' => ['question.update', $question->id], 'method' => 'patch']) !!}
      <div class="form-group {{ $errors->first('tag_category_id') ? 'has-error' : '' }}">
        ...
        {!! Form::select('tag_category_id', $tags, $question->tag_category_id, ['class' => 'form-control selectpicker form-size-smallz']) !!}
      ...
      <div class="form-group {{ $errors->first('content') ? 'has-error' : '' }}">
        {!! Form::textarea('content', $question->content ? : old('content'), ['placeholder' => 'Please write down your question here...', 'class' => 'form-control']) !!}
